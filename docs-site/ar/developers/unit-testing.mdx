---
title: "Writing Unit Tests for Anki"
---
...
start with one of the introductory resources in [References](#references-and-rationale),
...
[Svelte, TypeScript, and JavaScript](#svelte-typescript-and-javascript)).
...
change complete, run `just check`. See [Testing and Coverage](/ar/developers/testing-coverage)
for coverage commands and [End-to-End Testing](/ar/developers/e2e-testing) when the
