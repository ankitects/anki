...
- The handling of wildcards and escape characters in search [has been
  reworked](/ar/manual/searching#matching-special-characters)
...
- All translations have been migrated to [Fluent](/ar/translators/anki/developers).
...
- Fix negated conditionals being non-negated when renamed.
