...
**Language**\
Change your display language. You can help to improve translations [here](/translators)
...
<Info>
    Let's say you create new anki cards and many of those cards contain media files. If
    you add cards for an hour and have this setting turned on, then there will be 4
    smaller media uploads in total. Without this setting, you would have to upload the
    entire media with the next normal sync, which might take more time.
</Info>
