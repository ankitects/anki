...
deck-config-fsrs-params-using-default = 
    ...
    Continue to do reviews and optimize again later.
deck-config-fsrs-reviews-ignored-by-optimizer = 
    Reviews were found but they are ignored by the optimizer.
    This is likely because of "Ignore cards reviewed before" or because the cards only have reviews that were done on the day they were introduced.
