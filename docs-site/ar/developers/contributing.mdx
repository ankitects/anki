...
and add-ons, please see [the contribution guide](/ar/manual/contrib).
...
[Dependabot updates](/ar/developers/dependabot) when reviewing or landing them.
...
[the translation guide](/ar/translators/anki/developers).
