...
the collection. For more on the folder location, see the [file locations](./files#user-data) section. When you add media within Anki, either by
...
In Anki Desktop, deleting unused media moves the files into the profile's
`media.trash` folder, rather than your operating system's trash. If you
accidentally delete files you still need, use Tools&gt;Check Media to restore
them. Empty Trash permanently deletes the files from `media.trash` without
moving them to your operating system's trash, so you cannot restore them
through Check Media after emptying it.
