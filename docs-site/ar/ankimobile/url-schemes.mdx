...
online dictionary site. This is documented [in this section](/ar/manual/templates/fields#dictionary-links) of
the manual, though please start from the [cards & templates](/ar/manual/templates/intro) section
