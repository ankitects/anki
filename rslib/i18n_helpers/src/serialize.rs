// copied from https://github.com/RumovZ/fluent-rs/tree/serializer
// which itself is a copy of https://github.com/projectfluent/fluent-rs/pull/184
// with fixes for fluent-syntax 0.11.0
