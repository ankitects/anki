...
Then open your collection's media folder ([File Locations](/manual/files#user-data)) and locate the file that is referenced. If the file does not use exactly the same combination of lowercase or uppercase letters, you've found the problem.
