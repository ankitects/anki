...
about it in the [add-on writing guide](/addons/debugging#debug-console).
...
resulting output, copy it from the bottom area, and paste it back to the support person.
