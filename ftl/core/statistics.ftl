...
statistics-card-stability-subtitle = Predicted interval for the retrievability to drop from 100% to 90%. Combined with desired retention to determine the next interval.
