...
this, see the [using decks appropriately](./editing#using-decks-appropriately) section.

For information on how the order of decks affects the order cards are studied in,
see the [display order](./studying#display-order) section.
...
editing notes. For more information on card types, see the [Cards and Templates](templates/intro) section.
...
- **Image Occlusion**\
  ...
  such as anatomy and geography. For details, see the [Image Occlusion](./editing#image-occlusion)
