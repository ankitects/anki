...
preferences-minimize-distractions = Minimize distractions during review
preferences-minimize-distractions-tooltip = Hide distracting UI elements (e.g. the toolbar) during review
