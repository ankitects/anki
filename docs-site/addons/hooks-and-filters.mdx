...
[Hooks Reference](/addons/hooks-reference) page.

If you have set up type completion as described in an earlier section,
you can also see the hooks in your IDE:

<video controls autoplay loop muted alt="Autocomplete in PyCharm">
 <source src="/media/autocomplete.mp4" type="video/mp4"/>
</video>
...
For a full list of hooks and their documentation, see the
[Hooks Reference](/addons/hooks-reference) page, or browse the source directly:
