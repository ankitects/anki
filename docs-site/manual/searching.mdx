...
`sc:mnemonic`\
matches a note containing `&#123;&#123;c1::mn&#123;&#123;c2::emonic`.
...
For more information on regular expressions, see [this website]([https://regexone.com/lesson/introduction_abcs](https://regexone.com/lesson/introduction_abcs)).
...
- For the specifics of Anki's regex support, see the [regex crate documentation]([https://docs.rs/regex/1.3.9/regex/#syntax](https://docs.rs/regex/1.3.9/regex/#syntax)).
