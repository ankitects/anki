...
<kbd>Shift</kbd>+<kbd>Enter</kbd> instead of just <kbd>Enter</kbd>, as a normal newline
...
<Note>
    Anki has special logic for cloze deletions that might not work if you change the
...
![convergence question](/media/convergence_question.png)
...
![convergence question 2](/media/convergence_question_2.png)
