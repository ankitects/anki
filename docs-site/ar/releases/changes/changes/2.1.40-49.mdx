...
Changes to the [v3 scheduler](/ar/faqs/the-2021-scheduler):
...
- A new scheduler is available, with a number of improvements. Please see the
  [2021 scheduler page](/ar/faqs/the-2021-scheduler) for
  more information.
...
- Don't forget CSV delimiter when canceling dialog (thanks to Benjamin).
