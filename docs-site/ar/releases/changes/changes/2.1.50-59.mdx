...
[/manual/misc#debug-console](/ar/manual/misc#debug-console)
...
- The sync server bundled with Anki has been updated, and now supports syncing
  ...
  [/manual/sync-server](/ar/manual/sync-server).
...
You can try it out by using `mw.pm.set_new_import_export(True)` in the [debug console](/ar/manual/misc#debug-console).
...
- [Windows](/ar/manual/platform/windows/installing#qt5-vs-qt6)
- [Mac](/ar/manual/platform/mac/installing#qt5-vs-qt6)
- [Linux](/ar/manual/platform/linux/installing#qt5-vs-qt6)
...
- Intermediate deck limits now affect their children. Please see the [scheduler
  page](/ar/faqs/the-2021-scheduler#daily-limits) for more
  info.
