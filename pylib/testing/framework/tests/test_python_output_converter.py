...
class PythonOutputConverterTests(unittest.TestCase):
    ...
    def test_array_of_arrays_of_ints(self):
        ...
        self.assertEqual(ConverterFn('', 'return value', 'List[int]', 'List[int]'), converters[1])
        self.assertEqual(ConverterFn('a', 'return value', 'List[List[int]]', 'List[List[int]]'), converters[2])
    ...
    def test_obj_nested_list(self):
        ...
        self.assertEqual(ConverterFn('', 'return value', 'int', 'int'), converters[0])
        self.assertEqual(ConverterFn('a', 'return value', 'List[int]', 'List[int]'), converters[1])
    ...
    def test_map(self):
        ...
        self.assertEqual(ConverterFn('a', 'return value', 'List[int]', 'List[int]'), converters[2])
