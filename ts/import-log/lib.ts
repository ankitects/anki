    ...
    const summarizedQueues = [
        {
            ...
            action: tr.addingAdded(),
            summary_template: tr.importingNotesAdded,
            canBrowse: true,
            icon: newBox,
        },
        {
            ...
            action: tr.importingSkipped(),
            summary_template: tr.importingExistingNotesSkipped,
            canBrowse: true,
            icon: checkBold,
        },
        {
            ...
            action: tr.importingSkipped(),
            summary_template: tr.importingConflictingNotesSkipped,
            canBrowse: false,
            icon: alphaXBox,
        },
        {
            ...
            action: tr.importingUpdated(),
            summary_template: tr.importingNotesUpdated,
            canBrowse: true,
            icon: updateIcon,
        },
    ];
