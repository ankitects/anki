...
SuperMemo algorithm called [SM-2](/faqs/what-spaced-repetition-algorithm). Recently, a new algorithm called [FSRS](/manual/deck-options.html?highlight=FSRS#fsrs) has been integrated as an alternative to the legacy SM-2 algorithm.
