...
If you have a test coming up and need to review the material before it is due, you can tell Anki you'd like to [review outside of the regular schedule](/manual/filtered-decks). If you just want to quickly flip through some cards to check for mistakes after creating them or get a general idea of what's there, you can use the **Preview** button in the upper-right corner of the Browse screen.
...
[Settings for using Anki to prepare for a large exam](/faqs/settings-for-using-anki-to-prepare-for-a-large-exam)
