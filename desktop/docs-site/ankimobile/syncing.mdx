...
2. If prompted to upload or download, choose 'upload' to send your
   cards to AnkiWeb. Please make sure you [wait for media files to finish syncing](/faqs/media-files-may-take-time-to-sync).

3. Tap Synchronize in AnkiMobile and then 'download' to grab the cards
   from AnkiWeb. Please make sure you [wait for media files to finish syncing](/faqs/media-files-may-take-time-to-sync).
...
some time, and until it completes, [sounds and images may fail to appear](/faqs/media-files-may-take-time-to-sync).
...
is because [media has not finished syncing yet](/faqs/media-files-may-take-time-to-sync). Please follow the steps on that page
