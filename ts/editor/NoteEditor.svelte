...
<div class="note-editor" bind:clientHeight>
    <FieldsEditor>
                        ...
                        {#each fieldsData as field, index}
                            ...
                            >
                                <svelte:fragment slot="field-label">
                                    <LabelContainer
                                        ...
                                        on:toggle={async () => {
                                            ...
                                            const defaultInput = !plainTextDefaults[
                                                index
                                            ]
                                ...
                                <svelte:fragment slot="plain-text-input">
                                    <Collapsible
                                        collapsed={plainTextsHidden[index]}
                                        let:hidden
                                    >
                                        <PlainTextInput
                                            {hidden}
        ...
        <HorizontalResizer components={[fieldsPane, tagsPane]} {clientHeight} />
        <Pane bind:this={tagsPane}>
            <PaneContent>
