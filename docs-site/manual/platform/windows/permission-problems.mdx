...
sidebarTitle: "Permission Problems"
...
- type the following, hitting <kbd>Enter</kbd> after each line, and replacing \_\_\_\_ (and keeping the :F part) with your username from the previous command
