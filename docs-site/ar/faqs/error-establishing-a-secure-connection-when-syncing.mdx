...
[https://anki.tenderapp.com/kb/problems/syncing-failed-connection-timed-out-errors-when-syncing](https://anki.tenderapp.com/kb/problems/syncing-failed-connection-timed-out-errors-when-syncing)
