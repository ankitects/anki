    ...
    (r = {
                        ...
                        if ("string" != typeof t) {
                            ...
                            if (
                                ...
                                for (
                                    ...
                                    (r[s] = n[s]), (e[s] = t[n[s++]]);
                                return (
                                    (r[s] = i), Function.apply(null, r).apply(null, e)
                                );
                            }
                            return Function(i)();
                        }
                        ...
                        if ((e && (i = -i), 0 === i))
                            ...
                            t(
                                ((e << 31) |
                                    ((127 + s) << 23) |
                                    (8388607 &
                                        Math.round(i * Math.pow(2, -s) * 8388608))) >>>
                                    0,
                                n,
                                r
                            );
                    ...
                    return (
                        "undefined" != typeof Float32Array
                            ? ((o = new Float32Array([-0])),
                              ...
                              (h = 128 === f[3]),
                              (t.writeFloatLE = h ? r : e),
                              (t.writeFloatBE = h ? e : r),
                              (t.readFloatLE = h ? s : u),
                              (t.readFloatBE = h ? u : s))
                            : ((t.writeFloatLE = i.bind(null, w)),
                              (t.writeFloatBE = i.bind(null, g)),
                              (t.readFloatLE = n.bind(null, j)),
                              (t.readFloatBE = n.bind(null, k))),
                        "undefined" != typeof Float64Array
                            ? ((c = new Float64Array([-0])),
                              (a = new Uint8Array(c.buffer)),
                              (l = 128 === a[7]),
                              (t.writeDoubleLE = l ? b : y),
                              (t.writeDoubleBE = l ? y : b),
                              (t.readDoubleLE = l ? p : m),
                              (t.readDoubleBE = l ? m : p))
                            : ((t.writeDoubleLE = v.bind(null, w, 0, 4)),
                              (t.writeDoubleBE = v.bind(null, g, 4, 0)),
                              (t.readDoubleLE = d.bind(null, j, 0, 4)),
                              (t.readDoubleBE = d.bind(null, k, 4, 0))),
                        t
                    );
                }
                function w(t, i, n) {
                ...
                (r.fromObject = function (t) {
                    ...
                    (r.toObject = function (t) {
                        ...
                        for (
                            ...
                            i[u].partOf ||
                                (i[u].resolve().repeated ? r : i[u].map ? e : s).push(
                                    i[u]
                                );
                        if (r.length) {
                            for (
                                n("if(o.arrays||o.defaults){"), u = 0;
                                u < r.length;
                                ++u
                            )
        ...
        14: [
            function (t, i) {
                i.exports = e;
                var o = t(22);
                ((e.prototype = Object.create(o.prototype)).constructor = e).className =
                    "Enum";
                var n = t(21),
                    r = t(33);
        ...
        15: [
            function (t, i) {
                i.exports = u;
                var o = t(22);
                ((u.prototype = Object.create(o.prototype)).constructor = u).className =
                    "Field";
                var n,
                    r = t(14),
                    f = t(32),
        ...
        18: [
            function (t, i) {
                i.exports = s;
                var u = t(15);
                ((s.prototype = Object.create(u.prototype)).constructor = s).className =
                    "MapField";
                var n = t(32),
                    o = t(33);
        ...
        20: [
            function (t, i) {
                i.exports = n;
                var f = t(22);
                ((n.prototype = Object.create(f.prototype)).constructor = n).className =
                    "Method";
                var h = t(33);
        ...
        23: [
            function (t, i) {
                i.exports = s;
                var e = t(22);
                ((s.prototype = Object.create(e.prototype)).constructor = s).className =
                    "OneOf";
                var n = t(15),
                    r = t(33);
                function s(t, i, n, r) {
            ...
            function (t, i) {
                ...
                function a() {
                    ...
                    if (!(4 < this.len - this.pos)) {
                        for (; i < 3; ++i) {
                            ...
                            if (
                                ((t.lo =
                                    (t.lo | ((127 & this.buf[this.pos]) << (7 * i))) >>>
                                    0),
                ...
                (o.create = f()),
                    ...
                    (o.prototype.uint32 =
                        ...
                        function () {
                            if (
                                ((h = (127 & this.buf[this.pos]) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return h;
                            if (
                                ((h = (h | ((127 & this.buf[this.pos]) << 7)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return h;
                            if (
                                ((h = (h | ((127 & this.buf[this.pos]) << 14)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return h;
                            if (
                                ((h = (h | ((127 & this.buf[this.pos]) << 21)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return h;
                            if (
                                ((h = (h | ((15 & this.buf[this.pos]) << 28)) >>> 0),
                                this.buf[this.pos++] < 128)
                            )
                                return h;
        ...
        26: [
            function (t, i) {
                i.exports = n;
                var r = t(21);
                ((n.prototype = Object.create(r.prototype)).constructor = n).className =
                    "Root";
                var e,
                    v,
                    d,
                ...
                (n.fromJSON = function (t, i) {
                    ...
                    (n.prototype.fetch = b.fetch),
                    (n.prototype.load = function t(i, s, e) {
                                ...
                                if (
                                    ...
                                    if (r.weakImports)
                                        for (e = 0; e < r.weakImports.length; ++e)
                                            (n =
                                                h(r.weakImports[e]) ||
                                                u.resolvePath(t, r.weakImports[e])) &&
                                                a(n, !0);
        ...
        29: [
            function (t, i) {
                ...
                )).constructor = n).prototype.rpcCall = function t(n, i, r, e, s) {
        ...
        30: [
            function (t, i) {
                i.exports = u;
                var r = t(21);
                ((u.prototype = Object.create(r.prototype)).constructor = u).className =
                    "Service";
                var s = t(20),
                    o = t(33),
                    f = t(28);
                    ...
                    (u.prototype.remove = function (t) {
                        if (t instanceof s) {
                            if (this.methods[t.name] !== t)
                                throw Error(t + " is not a member of " + this);
                            return (
                                delete this.methods[t.name], (t.parent = null), n(this)
                            );
                        }
        ...
        31: [
            function (t, i) {
                i.exports = w;
                var u = t(21);
                ((w.prototype = Object.create(u.prototype)).constructor = w).className =
                    "Type";
                var o = t(14),
                    f = t(23),
                    h = t(15),
                ...
                Object.defineProperties(w.prototype, {
                    ...
                    ctor: {
                        get: function () {
                            return (
                                this.l || (this.ctor = w.generateConstructor(this)())
                            );
                        },
                        set: function (t) {
                            var i = t.prototype;
                    ...
                    (w.fromJSON = function (t, i) {
                        ...
                        for (var r = Object.keys(i.fields), e = 0; e < r.length; ++e)
                            n.add(
                                (void 0 !== i.fields[r[e]].keyType
                                    ? c.fromJSON
                                    : h.fromJSON)(r[e], i.fields[r[e]])
                            );
                        if (i.oneofs)
                    ...
                    (w.prototype.add = function (t) {
                        ...
                        if (t instanceof h && t.extend === g) {
                            ...
                            if (this.isReservedName(t.name))
                                throw Error(
                                    "name '" + t.name + "' is reserved in " + this
                                );
                            return (
            ...
            function (t, i, n) {
                ...
                (r.asPromise = t(1)),
                    ...
                    (r.oneOfGetter = function (t) {
                        ...
                        return function () {
                            for (
                                var t = Object.keys(this), i = t.length - 1;
                                -1 < i;
                                --i
                            )
                                if (
            ...
            function (t, i) {
                i.exports = function (t) {
                    ...
                    for (var e = 0; e < t.fieldsArray.length; ++e) {
                        ...
                        if (
                            (s.optional &&
                                i("if(%s!=null&&m.hasOwnProperty(%j)){", u, s.name),
                            s.map)
                        )
            ...
            function (t, i, n) {
                ...
                r[".google.protobuf.Any"] = {
                    fromObject: function (t) {
                        if (t && t["@type"]) {
                            var i = t["@type"].substring(
                                    1 + t["@type"].lastIndexOf("/")
                                ),
                                n = this.lookup(i);
                            if (n) {
                                var r =
                    ...
                    toObject: function (t, i) {
                        ...
                        if (i && i.json && t.type_url && t.value) {
                            (r = t.type_url.substring(1 + t.type_url.lastIndexOf("/"))),
                                (n = t.type_url.substring(
                                    0,
                        ...
                        if (t instanceof this.ctor || !(t instanceof u))
        ...
        38: [
            function (t, i) {
                ...
                (c.create = a()),
                    ...
                    r.Array !== Array &&
                        (c.alloc = r.pool(c.alloc, r.Array.prototype.subarray)),
                    ...
                    ((v.prototype = Object.create(o.prototype)).fn = function (
                        t,
                        i,
                        n
                    ) {
                    ...
                    (c.prototype.uint32 = function (t) {
                        return (
                            (this.len += (this.tail = this.tail.next = new v(
                                (t >>>= 0) < 128
                                    ? 1
                                    : t < 16384
                                    ? 2
                    ...
                    (c.prototype.int32 = function (t) {
                        return t < 0 ? this.y(d, 10, e.fromNumber(t)) : this.uint32(t);
                    }),
                ...
                (c.prototype.bytes = function (t) {
                    var i = t.length >>> 0;
                    if (!i) return this.y(l, 1, 0);
                    if (r.isString(t)) {
                        var n = c.alloc((i = s.length(t)));
                        s.decode(t, n, 0), (t = n);
                    }
                    return this.uint32(i).y(y, i, t);
                }),
                    (c.prototype.string = function (t) {
                        var i = u.length(t);
                        return i ? this.uint32(i).y(u.write, i, t) : this.y(l, 1, 0);
                    }),
            ...
            function (t, i) {
                ...
                (e.r = function () {
                    ...
                    (e.prototype.bytes = function (t) {
                        ...
                        var i = t.length >>> 0;
                        return (
                            this.uint32(i), i && this.y(e.writeBytesBuffer, i, t), this
                        );
                    }),
                    (e.prototype.string = function (t) {
                        var i = r.Buffer.byteLength(t);
                        return this.uint32(i), i && this.y(s, i, t), this;
                    }),
                    e.r();
            },
            { 35: 35, 38: 38 },
