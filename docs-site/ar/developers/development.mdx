...
- [Windows](/ar/developers/windows)
- [Mac](/ar/developers/mac)
- [Linux](/ar/developers/linux)
...
If Anki fails to start, you may need to install [extra libraries](/ar/manual/platform/linux/missing-libraries).
...
Please see [this separate page](/ar/developers/editing) for setting up an editor/IDE.

## Making changes to the build

See [this page](/ar/developers/build)
...
See [Releasing](/ar/developers/releasing).
