...
Please see [/ar/manual/templates/fields#text-to-speech-for-individual-fields](/ar/manual/templates/fields#text-to-speech-for-individual-fields)

<h1>For AnkiMobile 2.0.56+</h1>

Please see [/ar/ankimobile/tts](/ar/ankimobile/tts)
...
If you want to use the generated files outside the computer version, make sure you use the stored files mode and not 'on the fly': [https://ankiatts.appspot.com/usage/editor](https://ankiatts.appspot.com/usage/editor)
