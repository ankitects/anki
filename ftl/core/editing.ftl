...
editing-image-occlusion-zoom-out = Zoom Out (Ctrl+-)
editing-image-occlusion-zoom-in = Zoom In (Ctrl++)
editing-image-occlusion-zoom-reset = Reset Zoom (F)
editing-image-occlusion-toggle-translucent = Toggle Translucency (L)
editing-image-occlusion-delete = Delete (Del)
editing-image-occlusion-duplicate = Duplicate (D)
editing-image-occlusion-group = Group Selection (G)
editing-image-occlusion-ungroup = Ungroup Selection (U)
editing-image-occlusion-alignment = Alignment
editing-image-occlusion-align-left = Align Left (Shift+L)
editing-image-occlusion-align-h-center = Align Horizontal Centers (Shift+H)
editing-image-occlusion-align-right = Align Right (Shift+R)
editing-image-occlusion-align-top = Align Top (Shift+T)
editing-image-occlusion-align-v-center = Align Vertical Centers (Shift+V)
editing-image-occlusion-align-bottom = Align Bottom (Shift+B)
editing-image-occlusion-select-tool = Select (S)
editing-image-occlusion-zoom-tool = Zoom (M)
editing-image-occlusion-rectangle-tool = Rectangle (R)
editing-image-occlusion-ellipse-tool = Ellipse (E)
editing-image-occlusion-polygon-tool = Polygon (P)
editing-image-occlusion-text-tool = Text (T)
