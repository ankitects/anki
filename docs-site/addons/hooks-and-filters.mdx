...
An easy way to see all hooks at a glance is to look at [pylib/tools/genhooks.py](https://github.com/ankitects/anki/tree/main/pylib/tools/genhooks.py) and [qt/tools/genhooks\_gui.py](https://github.com/ankitects/anki/blob/main/qt/tools/genhooks_gui.py).
