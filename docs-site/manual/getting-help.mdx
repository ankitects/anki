...
Report AnkiWeb bugs and ask support questions on the user forums, where
reports are triaged. The GitHub issue tracker is for development work;
please use the forums as your first point of contact for AnkiWeb issues.
...
See [AnkiMobile's support page](/ankimobile/support).
