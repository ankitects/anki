...
test("already-optimal message is empty when not already optimal", () => {
    const message = getUnchangedReasonMessage(false, true, 1, 5);
    const message2 = getUnchangedReasonMessage(false, false, 1, 5);
