...
export const lineKeyCombination = "L";
export const pathKeyCombination = "O";
export const highlighterKeyCombination = "H";
...
export const toggleTranslucentKeyCombination = "C";
