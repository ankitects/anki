...
In a hurry? Jump straight to [Getting Started](./getting-started).

## Getting Help

Looking for help? Please see [Getting Help](./getting-help).
...
- [فارسى](https://msadrashakouri.ir/anki-manual/)
...
please see the [translation docs](/translators/anki/manual).
...
For information on old scheduler versions, see [this FAQ](/faqs/the-anki-2.1-scheduler).
