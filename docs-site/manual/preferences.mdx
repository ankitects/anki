...
properly with this option enabled - see [night mode styling](./templates/styling#night-mode) for more information.
...
Note: If you're on Windows, check [this page](./platform/windows/display-issues) as well.
...
See [this](./backups#automatic-backups) section of the manual.
