...
architecture](https://github.com/ankitects/anki/blob/main/docs/architecture)
available.

While it is possible to develop Anki add-ons with just a plain text editor, you
can make your life much easier by using a proper code editor/IDE. Please see the [Editor Setup](/addons/editor-setup) section for more information.
