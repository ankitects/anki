...
If Anki will not install or start, first check the troubleshooting advice for
your operating system in the [platform notes](./platform/intro):

- [Windows installation issues](./platform/windows/installation-issues) and
  [startup issues](./platform/windows/startup-issues)
- [macOS installation notes](./platform/mac/installing)
- [Linux missing libraries](./platform/linux/missing-libraries) and
  [blank windows](./platform/linux/blank-window)

For other problems, or if the platform-specific advice does not resolve the
issue, try the following steps in order:
...
<kbd>Shift</kbd> key while starting Anki. Keep holding <kbd>Shift</kbd> down until the
on-screen message informs you that Anki has started in safe mode. If you're on Linux and
that didn't work, run `anki --safemode`.
...
- [Windows](/manual/platform/windows/display-issues)
- [Mac](/manual/platform/mac/display-issues)
- [Linux](/manual/platform/linux/display-issues)
