...
If the [learning steps](/ar/manual/deck-options) are set to be longer than the [graduating or easy interval](/ar/manual/deck-options), Hard/Good might show longer intervals than Good/Easy.
