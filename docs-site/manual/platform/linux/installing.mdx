...
packaged version, but you may be able to use the [Python wheels](/releases/betas#via-pypipip)
instead.
...
```shell
tar xaf Downloads/anki-2X.XX-linux-x86_64.tar.zst
cd anki-linux-2X.XX-*
sudo ./install.sh
```
