...
online dictionary site. This is documented [in this section](/manual/templates/fields#dictionary-links) of
the manual, though please start from the [cards & templates](/manual/templates/intro) section
