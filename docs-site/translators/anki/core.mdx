...
![A simple translation string](/media/simple-replacement@2x.png)
...
![A translation string with a variable](/media/variable@2x.png)
...
![A translation string with plural forms](/media/simple-plurals@2x.png)
...
![Editing translation strings with advanced plurals](/media/advanced-plurals@2x.png)
...
![Editing a translation string to add plurals](/media/advanced-plurals2@2x.png)
...
![Another example of plural forms](/media/advanced-plurals3@2x.png)

To fix this, we click on the FTL button to get a blank template:

![Template view of plural forms](/media/advanced-plurals4@2x.png)

And then modify the template as required:

![Modifying the template view of plural forms](/media/advanced-plurals5@2x.png)
